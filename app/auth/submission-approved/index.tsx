      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            ...
            reviewing your references and background information. You will
            receive an email notification once your application has been fully
            approved.
          </Text>

          <View style={styles.emailNotification}>
            <Text style={styles.emailText}>
              📧 Check your email for approval notification, then log in again
              to access your Buddi portal.
            </Text>
          </View>
